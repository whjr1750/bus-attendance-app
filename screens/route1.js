...
export default class Route1Screen extends Component {
  constructor() {
    super();
    this.state = {
      allStudents: [],
  ...
  fetchDetails = async (number) => {
   ...
   updateAttendence(student_name,route_no, status) {
              ...
              <View style={{ flex: 1, flexDirection: 'row' }}>
                <TouchableOpacity
                  ...
                  onPress={() => {
                    ...
                    this.updateAttendence(student.student_name,student.student_routeNo, 'present');
                  }}>
                  <Text>Present</Text>
                </TouchableOpacity>
                ...
                <TouchableOpacity
                  ...
                  onPress={() => {
                   ...
                   this.updateAttendence(student.student_name,student.student_routeNo, 'absent');
                  }}>
                  <Text>Absent</Text>
                </TouchableOpacity>
              </View>
